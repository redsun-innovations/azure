...
import com.redsun.Hierarchy_Api.repository.FacetRepository;
...
public class FacetServiceTests {
    ...
    @Test
    public void testSearchFacets_WithValidInput() {
    ...
    @Test
    public void testSearchFacets_WithMissingFacetTypes() {
    ...
    public void testListData() {
        ...
        when(facetRepository.listData(eq(pageNumber), eq(pageSize))).thenReturn(mockData);
