...
class HierarchyServiceTest {
    ...
    @Test
    void testFetchHierarchyDataException() {
        String base36Ids = "mgr0ZmgrwZ4z7lv";
        List<String> base36IdList = Arrays.asList("mgr0", "mgrw", "4z7lv");

        when(cosmosDbHierarchyRepository.findHierarchyByBase36Ids(base36IdList)).thenThrow(new RuntimeException("Error"));

        List<Map<String, Object>> result = hierarchyService.fetchHierarchyData(base36Ids);
